 const toggleDarkModeBtn = document.getElementById('toggleDarkMode');
    ...
    if (enabled) {
        ...
        toggleBtn.classList.remove('bg-blue-800', 'text-white');
        toggleBtn.classList.add('bg-orange-400', 'text-black');
    } else {
        html.classList.remove('dark');
        localStorage.setItem('theme', 'light');
        toggleBtn.classList.remove('bg-orange-400', 'text-black');
        toggleBtn.classList.add('bg-blue-800', 'text-white');
    }
    }
...
        ;
        ...
        function applyPromoCode() {
            ...
            applyPromoBtn.classList.remove('bg-teal-600', 'bg-teal-700');
        ...
        function resetPromoCode() {
            ...
            applyPromoBtn.classList.add('bg-teal-600', 'bg-teal-700');
        ...
        function showPaymentModal(transaction) {
            paymentDetails.innerHTML = `
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-lime-600">
                        <span>Diskon:</span>
                    ...
                    <div class="flex justify-between text-lg font-semibold">
                        <span>Total:</span>
                        <span class="text-lime-600">${formatCurrency(transaction.total)}</span>
                    </div>
                </div>
            `;
